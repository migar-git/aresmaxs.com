...
# AGENTS.md — Governed Swarm Assignment: aresmaxs.com
...
iteration:
  ...
  branch_pattern: "agency/aresmaxs.com/{gap_id}"
  pr_title_pattern: "swarm(aresmaxs.com): {gap_id} — {description}"
